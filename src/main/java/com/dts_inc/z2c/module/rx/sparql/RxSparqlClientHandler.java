 ...
 *
 */
public class RxSparqlClientHandler extends SimpleChannelInboundHandler<HttpObject> {
	static Logger logger = LoggerFactory.getLogger(RxSparqlClientHandler.class);
	...
	public RxSparqlClientHandler(Subscriber<? super String> subscriber) {
